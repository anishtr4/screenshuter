      ...
      <div className="w-full max-w-md relative z-10">
        <Card className="bg-white/80 dark:bg-orange-900/20 backdrop-blur-md border-orange-200/50 dark:border-orange-700/30 shadow-2xl">
          <CardHeader className="text-center pb-2">
            ...
            <CardTitle className="text-2xl font-bold text-orange-900 dark:text-orange-100">Sign In</CardTitle>
          ...
          <CardContent className="pt-6">
            ...
            <div className="mt-6 p-4 bg-orange-100/50 dark:bg-orange-800/20 backdrop-blur-sm rounded-lg border border-orange-200/50 dark:border-orange-700/30">
              <p className="text-xs font-medium text-orange-800 dark:text-orange-200 mb-2">Demo Credentials:</p>
              <p className="text-xs text-orange-700 dark:text-orange-300 font-mono">
                <strong className="text-orange-800 dark:text-orange-200">Admin:</strong> admin@screenshot-saas.com / admin123
              </p>
            </div>
          </CardContent>
        </Card>
