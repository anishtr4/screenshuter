...
export default function DashboardPage() {
  ...
  useEffect(() => {
    console.log('Dashboard auth check:', { token: !!token, user: !!user, isAuthenticated })
    
    // Temporarily disable auth redirect to test dashboard loading
    // Just load projects regardless of auth state for testing
    loadProjects()
    ...
    //   return
    // }
  }, [token, user, router, isAuthenticated])
